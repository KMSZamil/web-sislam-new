                ...
                @foreach ($ExchangeCars as $row)
                    <tr>
                        ...
                        <td><a class="btn btn-fw btn-sm primary" href="{{ route('editSell', ['id' => $row->id]) }}">
                                ...
                                &nbsp; {{ __('backend.edit') }}</a>&nbsp;
                            <a class="btn btn-fw btn-sm secondary"
                                href="{{ route('showSell', ['id' => $row->seller_car_id]) }}">
                                <i class="material-icons">&#xe02e;</i>
                                &nbsp; {{ __('backend.view_details_seller_car') }}</a>
                            <a class="btn btn-fw btn-sm secondary"
                                href="{{ route('showSell', ['id' => $row->showroom_car_id]) }}">
                                <i class="material-icons">&#xe02e;</i>
                                &nbsp; {{ __('backend.view_details_showroom_car') }}</a>
                            {{-- s --}}
