                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="car_title" id="car_title"
                                            value="{{ old('car_title', $carDetails->car_title) }}">
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="car_condition" id="car_condition" required>
                                            @foreach ($CarConditions as $row)
                                                <option
                                                    {{ old('car_condition', $carDetails->car_condition) == $row->id ? 'selected' : '' }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="made_in" id="made_in" required>
                                            @foreach ($Country as $row)
                                                <option
                                                    {{ old('made_in', $carDetails->made_in) == $row->id ? 'selected' : '' }}
                                                    value="{{ $row->id }}">{{ $row->title_en }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="brand" id="brand" required>
                                            @foreach ($CarBrands as $row)
                                                <option
                                                    {{ old('car_brand', $carDetails->brand) == $row->id ? 'selected' : '' }}
                                                    value="{{ $row->id }}">{{ $row->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="car_model" id="car_model" required>
                                            @foreach ($CarModels as $row)
                                                <option
                                                    {{ old('car_model', $carDetails->car_model) == $row->id ? 'selected' : '' }}
                                                    value="{{ $row->id }}">{{ $row->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="menufacturing_year" id="menufacturing_year"
                                            ...
                                            ?>
                                            echo '<option
                                                {{ old('car_brand', $carDetails->menufacturing_year) == $i ? 'selected' : '' }}
                                                value="{{ $i }}">{{ $i }}</option>';
                                            <?php
                                                }
                                            ?>
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="body_type" id="body_type">
                                            ...
                                            @foreach ($BodyTypes as $row)
                                                <option
                                                    {{ old('car_brand', $carDetails->body_type) == $row->id ? 'selected' : '' }}
                                                    value="{{ $row->id }}">{{ $row->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control numeric" name="milage" id="milage"
                                            value="{{ old('milage', $carDetails->milage) }}">
                                    </div>
                                </div>
                                @php
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control numeric"
                                            value="{{ old('engine_capacity', $carDetails->engine_capacity) }}"
                                            name="engine_capacity" id="engine_capacity">
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="transmission" id="transmission">
                                            ...
                                            @foreach ($Transmissions as $row)
                                                <option
                                                    {{ old('transmission', $carDetails->transmission) == $row->id ? 'selected' : '' }}
                                                    value="{{ $row->id }}">{{ $row->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="drive_type" id="drive_type">
                                            ...
                                            @foreach ($Drives as $row)
                                                <option
                                                    {{ old('drive_type', $carDetails->drive_type) == $row->id ? 'selected' : '' }}
                                                    value="{{ $row->id }}">{{ $row->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="exterior_color" id="exterior_color">
                                            ...
                                            @foreach ($ExteriorColors as $row)
                                                <option
                                                    {{ old('exterior_color', $carDetails->exterior_color) == $row->id ? 'selected' : '' }}
                                                    value="{{ $row->id }}">{{ $row->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="interior_color" id="interior_color">
                                            ...
                                            @foreach ($InteriorColors as $row)
                                                <option
                                                    {{ old('interior_color', $carDetails->interior_color) == $row->id ? 'selected' : '' }}
                                                    value="{{ $row->id }}">{{ $row->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="registration_year" id="registration_year">
                                            ...
                                            <?php
                                                ...
                                                ?>
                                            <option
                                                {{ old('registration_year', $carDetails->registration_year) == $i ? 'selected' : '' }}
                                                value='{{ $i }}'>{{ $i }}</option>
                                            <?php                                             
                                                }
                                            ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="registration_city" id="registration_city">
                                            ...
                                            @foreach ($registration_cities as $row)
                                                <option
                                                    {{ old('registration_city', $carDetails->registration_city) == $row->id ? 'selected' : '' }}
                                                    value="{{ $row->id }}">{{ $row->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                            ...
                                            <div class="row">
                                                <select class="form-control" name="registration_serial"
                                                    ...
                                                    @foreach ($RegistrationSerial as $row)
                                                        <option {{ (old('registration_city', $carDetails->registration_serial) == $row->id) ? 'selected' : '' }} value="{{ $row->name }}">{{ $row->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="seats" id="seats">
                                            ...
                                            <?php
                                                ...
                                                {
                                                ?>
                                            <option {{ old('seats', $carDetails->seats) == $i ? 'selected' : '' }}
                                                value='{{ $i }}'>{{ $i }}</option>
                                            <?php                                               
                                                }
                                            ?>
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <select name="entertainment[]" id="entertainment"
                                            placeholder="Select {{ __('frontend.ENTERTAINMENT') }}"
                                            multiple="multiple">
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <select name="seat[]" id="seat"
                                            placeholder="Select {{ __('frontend.SEAT') }}" multiple="multiple">
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <select name="other_feature[]" id="other_feature"
                                            placeholder="Select {{ __('frontend.OTHER_FEATURE') }}"
                                            multiple="multiple">
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="date"
                                            value="{{ old('tax_token_expaire', date('Y-m-d', strtotime($carDetails->tax_token_expaire))) }}"
                                            class="form-control" name="tax_token_expaire" id="tax_token_expaire">
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control"
                                            value="{{ old('fitnes_exspaire', date('Y-m-d', strtotime($carDetails->fitnes_exspaire))) }}"
                                            name="fitnes_exspaire" id="fitnes_exspaire">
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="bank_loan"
                                            value="{{ old('bank_loan', $carDetails->bank_loan) }}" id="bank_loan">
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="name_transfer" id="name_transfer">
                                            <option value="">Select</option>
                                            <option @php
                                                if ($carDetails->name_transfer == 'Instant') {
                                                    echo 'selected';
                                                }
                                            @endphp value="Instant">Instant</option>
                                            <option @php
                                                if ($carDetails->name_transfer == 'Later') {
                                                    echo 'selected';
                                                }
                                            @endphp value="Later">Later</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <tbody class="">
                                                <tr class=" fade image in">
                                                    ...
                                                    <td>
                                                        ...
                                                        <a class="btn btn-danger car_photo_delete"
                                                            id="{{ $row->id }}"
                                                            style="float: left; margin: 0 5px; border-radius: 5px; box-shadow: unset;">
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    ...
                                    <input type="text" class="form-control"
                                        value="{{ old('price', $carDetails->price) }}" name="price" id="price">
                                </div>
                                <div class="col-sm-4">
                                    ...
                                    <select class="form-control" name="home_feature" id="home_feature">
                                        <option value="">Select</option>
                                        <option
                                            {{ old('home_feature', $carDetails->home_feature) == 1 ? 'selected' : '' }}
                                            value="1">Yes</option>
                                        <option
                                            {{ old('home_feature', $carDetails->home_feature) == 0 ? 'selected' : '' }}
                                            value="0">No</option>
                                    </select>
                                </div>
                                <div class="col-sm-4">
                                    ...
                                    <select class="form-control" name="status" id="status">
                                        <option value="">Select</option>
                                        <option {{ old('status', $carDetails->status) == 0 ? 'selected' : '' }}
                                            value="0">In Active</option>
                                        <option {{ old('status', $carDetails->status) == 1 ? 'selected' : '' }}
                                            value="1">In Store</option>
                                        <option {{ old('status', $carDetails->status) == 2 ? 'selected' : '' }}
                                            value="2">Sold Out</option>
                                        <option {{ old('status', $carDetails->status) == 2 ? 'selected' : '' }}
                                            value="2">Booked</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <input type="text" class="form-control"
                                        value="{{ old('video_url', $carDetails->video_url) }}" name="video_url"
                                        id="video_url">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <textarea class="form-control" rows="10" name="car_details"
                                        id="car_details">{{ old('car_details', $carDetails->car_details) }}</textarea>
                                </div>
                            </div>
        ...
        $('.car_photo_delete').click(function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: 'GET',
                        url: "{{ route('carsDestroyEdit', '_id') }}".replace('_id',
                            car_photo_id),
                        data: {
                            id: car_photo_id,
                            _token: CSRF_TOKEN
