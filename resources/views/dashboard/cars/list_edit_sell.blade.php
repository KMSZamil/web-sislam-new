                            ...
                            <div class="row-body">
                                <div class="row-inner">
                                    <div class="padding p-y-sm ">
                                        {{ Form::open(['route' => ['updateSell', $carDetails->id],'method' => 'POST','files' => true,'id' => 'fileupload','enctype' => 'multipart/form-data']) }}
                                        <h3>Car Details</h3>
                                        @include('dashboard.cars.editsell')
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="customer_mobile"
                                                            value="{{ old('bank_loan', $CustomerData->mobile) }}"
                                                            id="customer_mobile">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            value="{{ old('address_line1', $CustomerData->address_line1) }}"
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label>{{ __('backend.ADDRESS') }}</label>
                                                        <input type="text"
                                                            value="{{ old('address_line2', $CustomerData->address_line2) }}"
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <select name="status" id="status"
                                                        placeholder="Select {{ __('backend.STATUS') }}">
                                                        <option value="">Select</option>
                                                        @foreach ($Status as $row)
                                                            <option
                                                                {{ old('status', $carDetails->status) == $row->id ? 'selected' : '' }}
                ...
                <script type="text/javascript">
                    $(document).ready(function() {
                        ...
                        var multipleCancelButton = new Choices(
                            '#fuel_type,#comfort,#entertainment,#safety,#seat,#window,#other_feature,#status', {
