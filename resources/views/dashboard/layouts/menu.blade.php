                        ...
                        <ul class="nav-sub">
                            <li>
                                <a onclick="location.href ='{{ route('analytics', 'date') }}'">
                                    <span
                                        class="nav-text">{{ __('backend.ALLLEEADS') }}</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{route('addNewLeads')}}" onclick="location.href ='{{ route('addNewLeads') }}'">
                                    <span
                                        class="nav-text">{{ __('backend.ADDLEEADS') }}</span>
                                </a>
                            </li>
                            <li>
                                <a onclick="location.href ='{{ route('analytics', 'date') }}'">
                                    <span
                                        class="nav-text">{{ __('backend.IMPORTLEEADS') }}</span>
                                </a>
                            </li>
                        </ul>
                    </li>
