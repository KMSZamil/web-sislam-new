    ...
    <div class="left navside dark dk" layout="column">
        <div class="navbar navbar-md no-radius">
            ...
            <a class="navbar-brand" href="{{ route('adminHome') }}">
                <img src="{{ asset('assets/dashboard/images/sislam.png') }}" alt="Control">
                ...
                <ul class="nav" ui-nav>
                    ...
                    <li>
                        <a>
                            ...
                            <span class="nav-text">{{ __('backend.LEADCONTACTS') }}</span>
                        </a>
                        <ul class="nav-sub">
                            <li>
                                <a onclick="location.href ='{{ route('analytics', 'date') }}'">
                                    <span class="nav-text">{{ __('backend.ALLLEEADS') }}</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('addNewLeads') }}"
                                    onclick="location.href ='{{ route('addNewLeads') }}'">
                                    <span class="nav-text">{{ __('backend.ADDLEEADS') }}</span>
                                </a>
                            </li>
                            <li>
                                <a onclick="location.href ='{{ route('analytics', 'date') }}'">
                                    <span class="nav-text">{{ __('backend.IMPORTLEEADS') }}</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                                ...
                                <ul class="nav-sub">
                                    ...
                                    <li {{ $PathCurrentFolder == $currentFolder ? 'class=active' : '' }}>
                                        <a onclick="location.href ='{{ route('carsSell') }}'">
                                            <span class="nav-text">{{ __('backend.sellRequest') }}</span>
                                        </a>
                                    </li>
                                    <li {{ $PathCurrentFolder == $currentFolder ? 'class=active' : '' }}>
                                        <a onclick="location.href ='{{ route('carsBuy') }}'">
                                            <span class="nav-text">{{ __('backend.buyRequest') }}</span>
                                        </a>
                                    </li>
                                    <li {{ $PathCurrentFolder == $currentFolder ? 'class=active' : '' }}>
                                        <a onclick="location.href ='{{ route('carsExchange') }}'">
                                            <span class="nav-text">{{ __('backend.exchangeRequest') }}</span>
                                        </a>
                                    </li>
                                    ...
                                    <li {{ $PathCurrentFolder == $currentFolder ? 'class=active' : '' }}>
                                        <a onclick="location.href ='{{ route('carsAdd') }}'">
                                            <span class="nav-text">{{ __('backend.addShowroomCar') }}</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
