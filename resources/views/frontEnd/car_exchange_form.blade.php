            ...
            <div class="col-md-12">
                <div class="tab-pane active" id="tab-sel">
                    ...
                    <div class="form-group">
                        {!! Form::open(['route' => 'exchangeSubmitFinal', 'id' => 'fileupload', 'method' => 'post', 'files' => true]) !!}
                        @csrf
                        <input type="hidden" class="form-control" name="CustomerID" id="CustomerID"
                            value="{{ $CustomerID ?? '' }}" required>
                        <input type="hidden" class="form-control" name="SellerCarID" id="SellerCarID"
                            value="{{ $SellerCarID ?? '' }}" required>
                        <input type="hidden" class="form-control" name="ShowroomCarID" id="ShowroomCarID"
                            value="{{ $ShowroomCarID ?? '' }}" required>
