                        ...
                        <div class=" page-content">
                            ...
                            <input type="checkbox" class="form-check-input" name="terms_and_condition" value="1"
                                 ...
                                 <label class="form-check-label"
                                    ...
                                    <div class="col-sm-12">
                                    <button type="submit" name="send" class="btn btn-dark btn-block">{{ __('frontend.SUBMIT') }}</button>
                                    </div>
                    </div>
                {{ Form::close() }}
            </div>
        </div>
        <div class="col-sm-3 text-center"> <img src="{{ asset('uploads/frontend/car-details3.jpg') }}" alt="S Islam adds"></div> 
            </div>
    </div>
