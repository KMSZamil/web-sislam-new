            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        {!! Form::text('contact_name', @Auth::user()->name, ['placeholder' => __('frontend.yourName'), 'class' => 'form-control', 'id' => 'name', 'data-msg' => __('frontend.enterYourName'), 'data-rule' => 'minlen:4']) !!}
                        <div class="alert alert-warning validation"></div>
                    </div>
                    <div class="form-group">
                        {!! Form::email('contact_email', @Auth::user()->email, ['placeholder' => __('frontend.yourEmail'), 'class' => 'form-control', 'id' => 'email', 'data-msg' => __('frontend.enterYourEmail'), 'data-rule' => 'email']) !!}
                        <div class="validation"></div>
                    </div>
                    <div class="form-group">
                        {!! Form::text('contact_phone', '', ['placeholder' => __('frontend.phone'), 'class' => 'form-control', 'id' => 'phone', 'data-msg' => __('frontend.enterYourPhone'), 'data-rule' => 'minlen:4']) !!}
                        <div class="validation"></div>
                    </div>
                    <div class="form-group">
                        {!! Form::text('contact_subject', '', ['placeholder' => __('frontend.subject'), 'class' => 'form-control', 'id' => 'subject', 'data-msg' => __('frontend.enterYourSubject'), 'data-rule' => 'minlen:4']) !!}
                        <div class="validation"></div>
                    </div>
                    <div class="form-group">
                        {!! Form::textarea('contact_message', '', ['placeholder' => __('frontend.message'), 'class' => 'form-control', 'id' => 'message', 'rows' => '8', 'data-msg' => __('frontend.enterYourMessage'), 'data-rule' => 'required']) !!}
                        <div class="validation"></div>
                    </div>
                    ...
                    <div class="p20">
                        ...
                        @if (Helper::GeneralSiteSettings('contact_t4') != '')
                            <p>
                                ...
                                <span dir="ltr">{{ Helper::GeneralSiteSettings('contact_t4') }}</span>
                            </p>
                        @endif
