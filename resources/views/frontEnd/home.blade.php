    ...
    @if (count($TextBanners) > 0)
            ...
            <div class="container">
                <div class="flex-form">
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <a class="nav-link" href="#tab-buy-mob" data-toggle="tab"><i
                                    class="fa fa-credit-card fa-bsle"></i><br />{{ __('frontend.BUY') }}</a>
                        </li>
                        <li class="nav-item active">
                            <a class="nav-link" href="#tab-sel-mob" data-toggle="tab"><i
                                    class="fa fa-money fa-bsle"></i><br />{{ __('frontend.SELL') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#tab-exc-mob" data-toggle="tab"><i
                                    class="fa fa-exchange fa-bsle"></i><br />{{ __('frontend.EXCHANGE') }}</a>
                        </li>
                    </ul>
        ...
        <section class="content-row-no-bg p-b-0">
            <div class="container">
                <div class="home-sec row">
                    ...
                    <div class="col-md-2"></div>
                    <div class="col-md-6">
                        <p class="para-cont text-justify" style="font-size: 16px; margin-top: 15px; ">
                            {{ __('frontend.HOME1') }}</p>
                    </div>
                    <div class="col-md-6">
        ...
        <section class="content-row-no-bg p-b-0">
            <div class="container">
                <div class="why-we row">
                    ...
                    <div class="col-md-6">
                        <p class="para-cont" style="font-size: 16px;"><span style="font-weight: bold;"><i
                                    class="fa fa-check-circle fa-bse" style="margin: 0!important; font-size: 16px;"></i>
                                {{ __('frontend.WHYWET1') }}</span><br /><span>{{ __('frontend.WHYWEp1') }}</span></p>
                        <p class="para-cont" style="font-size: 16px;"><span style="font-weight: bold;"><i
                                    class="fa fa-check-circle fa-bse" style="margin: 0!important; font-size: 16px;"></i>
                                {{ __('frontend.WHYWET2') }}</span><br /><span>{{ __('frontend.WHYWEp2') }}</span></p>
                        <p class="para-cont" style="font-size: 16px;"><span style="font-weight: bold;"><i
                                    class="fa fa-check-circle fa-bse" style="margin: 0!important; font-size: 16px;"></i>
                                {{ __('frontend.WHYWET3') }}</span><br /><span>{{ __('frontend.WHYWEp3') }}</span></p>
                        <p class="para-cont" style="font-size: 16px;"><span style="font-weight: bold;"><i
                                    class="fa fa-check-circle fa-bse" style="margin: 0!important; font-size: 16px;"></i>
                                {{ __('frontend.WHYWET4') }}</span><br /><span>{{ __('frontend.WHYWEp4') }}</span></p>
                        <p class="para-cont" style="font-size: 16px;"><span style="font-weight: bold;"><i
                                    class="fa fa-check-circle fa-bse" style="margin: 0!important; font-size: 16px;"></i>
                                {{ __('frontend.WHYWET5') }}</span><br /><span>{{ __('frontend.WHYWEp5') }}</span></p>
                    </div>
                </div>
            </div>
        </section>
                        ...
                        <div class="col-md-4">
                            <a class="icon-box-link" href="#buy" title="Buy car">
                                ...
                                <div class="icon-box buy_box_side">
                                    <div class="icon-text">
                                        <h3 class="title heading-font" style="color:#232628; line-height: 1.5;"><i
                                                class="fa fa-credit-card fa-bsle"></i> {{ __('frontend.WANTBUY') }}</h3>
                                        <div class="content" style="line-height:17px;">
                                            <p style="line-height: 1.5;"><span
                                                    style="color: #000;">{{ __('frontend.BUYSHORTDETAILS') }}</span><a
                                                    href="/buy-a-car"><span style="color: #0978ad;">
                                                        ...{{ __('frontend.LEARNMORE') }}</span></a></p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-4">
                            <a class="icon-box-link" href="#buy" title="Sell car">
                                <div class="icon-box buy_box_center">
                                    <div class="icon-text">
                                        <h3 class="title heading-font" style="color:#fff; line-height: 1.5;"><i
                                                class="fa fa-money"></i> {{ __('frontend.WANTSELL') }}</h3>
                                        <div class="content" style="line-height:17px;">
                                            <p style="line-height: 1.5;"><span
                                                    style="color: #ffffff;">{{ __('frontend.SELLSHORTDETAILS') }}</span><a
                                                    href="/sell-a-car"><span style="color: #0978ad;">
                                                        ...{{ __('frontend.LEARNMORE') }}</span></p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-4">
                            <a class="icon-box-link" href="#buy" title="Exchange car">
                                ...
                                <div class="buy-box buy_box_side">
                                    <div class="icon-text">
                                        <h3 class="title heading-font" style="color:#232628; line-height: 1.5;"><i
                                                class="fa fa-exchange fa-bsle"></i> {{ __('frontend.WANTEXCHANGE') }}
                                        </h3>
                                        <div class="content" style="line-height:17px;">
                                            <p style="line-height: 1.5;"><span
                                                    style="color: #000;">{{ __('frontend.EXSHORTDETAILS') }}</span><a
                                                    href="/exchange-a-car"><span style="color: #0978ad;">
                                                        ...{{ __('frontend.LEARNMORE') }}</span></a></p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="list-info">
                                ...
                                <div class="col-xs-4">
                                    <div class="row"><img src="/uploads/frontend/icon/road.png" width="14"
                                            alt="Road"> {{ isset($data->milage) ? $data->milage . ' km' : '' }}</div>
                                </div>
                                <div class="col-xs-4">
                                    <div class="row"><img src="/uploads/frontend/icon/gear.png" width="14"
                                            alt="Gear">
                                        {{ isset($data->car_transmission->name) ? $data->car_transmission->name : '' }}
                                    </div>
                                </div>
                                <div class="col-xs-4">
                                ...
                                <div class="col-xs-4">
                                    <div class="row" style="font-size: 12px"><img
                                            src="/uploads/frontend/icon/fuel.png" width="14" alt="Fuel">
                                ...
                                <div class="col-xs-4">
                                    <div class="row"><img src="/uploads/frontend/icon/car-engine-cc.png"
                                            width="14" alt="Car Engine">
                                ...
                                <div class="col-xs-4">
                                    <div class="row"><img src="/uploads/frontend/icon/car-seat-si.png" width="14"
                                            alt="Car Seat SI"> {{ isset($data->seats) ? $data->seats : '' }}</div>
                                </div>
                            </div>
                            <div class="clear"></div>
        ...
        endforeach;
         ...
         ?>
                <div class="col-md-12 text-center">
                    <a href="{{ url('buy-a-car') }}"><button type="button" class="btn btn-warning btn-lg">View More
                            Cars</button></a>
                </div>
            </div>
        </section>
        <section class="content-row-no-bg p-b-0" style="padding-top: 0;">
            <div class="test-section wrap-section-border wow bounceInUp" data-wow-duration="2s"
                                            ...
                                            <div class="owl-wrapper">
                                                <div class="owl-item">
                                                    <div class="reviews">
                                                        ...
                                                        <iframe
                                                            src="https://www.facebook.com/plugins/post.php?href=https%3A%2F%2Fwww.facebook.com%2FkapilkarTT%2Fposts%2F3005312469796788&show_text=true&width=500"
                                                            width="100%" class="ifrm-review"
                                                ...
                                                <div class="owl-item">
                                                    <div class="reviews">
                                                        ...
                                                        <iframe
                                                            src="https://www.facebook.com/plugins/post.php?href=https%3A%2F%2Fwww.facebook.com%2Fmohammad.raselahamed.7%2Fposts%2F1585609011776855&show_text=true&width=500"
                                                            width="100%" class="ifrm-review"
                                                            style="border:none;overflow:hidden" scrolling="no"
                                                            frameborder="0" allowfullscreen="true"
                                                            allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe>
                                                ...
                                                <div class="owl-item">
                                                    <div class="reviews">
                                                        ...
                                                        <iframe
                                                            src="https://www.facebook.com/plugins/post.php?href=https%3A%2F%2Fwww.facebook.com%2Fpermalink.php%3Fstory_fbid%3D1561745950870895%26id%3D100011065154837&show_text=true&width=500"
                                                            width="100%" class="ifrm-review"
                                                            style="border:none;overflow:hidden" scrolling="no"
                                                            frameborder="0" allowfullscreen="true"
                                                            allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe>
                                                ...
                                                <div class="owl-item">
                                                    <div class="reviews">
                                                        <h3 class="reviews__title">BEST CARS!</h3>
                                                        <iframe
                                                            src="https://www.facebook.com/plugins/post.php?href=https%3A%2F%2Fwww.facebook.com%2Fpermalink.php%3Fstory_fbid%3D3046487975639813%26id%3D100008359201998&show_text=true&width=500"
                                                            width="100%" class="ifrm-review"
                                                            style="border:none;overflow:hidden" scrolling="no"
                                                            frameborder="0" allowfullscreen="true"
                                                            allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe>
                                                ...
                                                <div class="owl-item">
                                                    <div class="reviews">
                                                        <h3 class="reviews__title">BEST CARS!</h3>
                                                        <iframe
                                                            src="https://www.facebook.com/plugins/post.php?href=https%3A%2F%2Fwww.facebook.com%2Fshowkotosman.salim%2Fposts%2F4839794459423271&show_text=true&width=500"
                                                            width="100%" class="ifrm-review"
                                                            style="border:none;overflow:hidden" scrolling="no"
                                                            frameborder="0" allowfullscreen="true"
                                                            allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe>
                                                ...
                                                <div class="owl-item">
                                                    <div class="reviews">
                                                        <h3 class="reviews__title">BEST CARS!</h3>
                                                        <iframe
                                                            src="https://www.facebook.com/plugins/post.php?href=https%3A%2F%2Fwww.facebook.com%2Fakash.gangachara%2Fposts%2F4181245341979914&show_text=true&width=500"
                                                            width="100%" class="ifrm-review"
                                                            style="border:none;overflow:hidden" scrolling="no"
                                                            frameborder="0" allowfullscreen="true"
                                                            allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe>
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title"> <a class="accordion-toggle" data-toggle="collapse"
                                            data-parent="#accordion" href="#collapseOne"> <span
                                                class="glyphicon glyphicon-minus"></span> {{ __('frontend.FAQ1') }} </a>
                                    </h4>
                                </div>
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title"> <a class="accordion-toggle" data-toggle="collapse"
                                            data-parent="#accordion" href="#collapseTwo"> <span
                                                class="glyphicon glyphicon-plus"></span> {{ __('frontend.FAQ2') }} </a>
                                    </h4>
                                </div>
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title"> <a class="accordion-toggle" data-toggle="collapse"
                                            data-parent="#accordion" href="#collapseThree"> <span
                                                class="glyphicon glyphicon-plus"></span> {{ __('frontend.FAQ3') }} </a>
                                    </h4>
                                </div>
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <ul class="list-progress list-unstyled">
                                        <li class="list-progress__item"> <i class="icon flaticon-transport391"></i>
                                            <div class="list-progress__inner"> <span class="chart"
                                                    data-percent="900"><span class="percent">900</span>+<canvas
                                                        height="0" width="0"></canvas></span> <span
                                                    class="list-progress__name">COUNTRIES REACHED</span> </div>
                                        </li>
                                        <li class="list-progress__item"> <i class="icon flaticon-automobile8"></i>
                                            <div class="list-progress__inner"> <span class="chart"
                                                    data-percent="10000"><span class="percent">10000</span>+<canvas
                                                        height="0" width="0"></canvas></span> <span
                                                    class="list-progress__name">PASSED GRADUATES</span> </div>
                                        </li>
                                        <li class="list-progress__item"> <i class="icon flaticon-bus6"></i>
                                            <div class="list-progress__inner"> <span class="chart"
                                                    data-percent="120"><span class="percent">120</span>+<canvas
                                                        height="0" width="0"></canvas></span> <span
                                                    class="list-progress__name">QUALIFIED STAFF</span> </div>
                                        </li>
                                    </ul>
                                    <!-- end list-progress -->
                                </div>
        ...
        <section class="content-row-no-bg p-b-0" style="padding-top:0!important; margin-bottom: -30px;">
            ...
            <div id="map-container-google-1" class="z-depth-1-half map-container">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3648.447543218603!2d90.37358701464545!3d23.873743784528727!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755c5ed0832656f%3A0xefac156498e13b68!2sS%20Islam%20Cars!5e0!3m2!1sen!2sbd!4v1644868285341!5m2!1sen!2sbd"
