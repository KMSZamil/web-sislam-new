...
<div class="block-title">
    <div class="block-title__inner section-bg section-bg_second">
        <div class="bg-inner">
            <h2 class="ui-title-page">Car Details</h2>
...
<div class="container">
    ...
    <div class="col-md-8">
        <?php if ($carDetails->video_url): ?>
        <div id="car-video" style="position: relative; padding-bottom: 56.25%; height: 0;">
            <iframe id="car-video-ifrm" style="position: absolute; top: 0; left: 0;" width="100%" height="100%" src="{{$carDetails->video_url}}" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
        <?php else: ?>
        ...
        <div class="tabdesc">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="profile-tab" data-toggle="tab" href="#more_photo" role="tab" aria-controls="profile" aria-selected="false">Photo Gallery</a>
                </li>
            </ul>
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade fotorama" role="tabpanel" aria-labelledby="profile-tab" style="text-align: center;" id="more_photo" data-nav="thumbs" data-allowfullscreen="true" data-transition="slide" data-loop="true">
                    @php
                    foreach($carDetails->car_images as $row){
                    @endphp
                    <a href="{{ asset('files/'.$row->car_image) }}"><img src="{{ asset('files/'.$row->car_image) }}"></a>
...
<style>
    ...
    #car-video iframe.ytp-show-cards-title{
...
jQuery(document).ready(function ($) {
    jQuery('#car-video-ifrm').contents().find('.ytp-show-cards-title').hide();
