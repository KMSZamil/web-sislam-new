...
class carPhotoUploadController extends Controller {
    ...
    public function index($options = null, $initialize = true, $error_messages = null, Request $request) {
    ...
    protected function initialize() {
        //echo '<pre/>'; print_r($this->options['print_response']); exit();
    ...
    protected function file_vali($uploaded_file, $file, $error, $index, $content_range) {
        if ($error) {
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
        ...
        $file->type = $type;
        if ($this->file_vali($uploaded_file, $file, $error, $index, $content_range)) {
