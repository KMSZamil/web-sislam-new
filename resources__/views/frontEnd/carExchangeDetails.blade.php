        ...
        <div class="col-md-4">
            <div class="sidebar-right">
                <div class="car-details-book">
                    <h3 class="sidebar-title">Exchange With This Car</h3>
                    <ul>
                    ...
                    <div class="car-details">
                        <form action="{{ route('exchangeSubmit') }}" method="post">
                            @csrf
                            <input type="hidden" name="CustomerID" value="{{ $CustomerID }}">
                            <input type="hidden" name="SellerCarID" value="{{ $SellerCarID }}">
                            <input type="hidden" name="ShowroomCarID" value="{{ $ShowroomCarID }}">

                            <button type="submit" class="btn btn-warning btn-lg btn-block">Exchange Now</button>
