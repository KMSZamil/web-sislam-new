...
class carDetailsController extends Controller {
    ...
    public function fbCcardetails($id) {
        ...
        $same_car = Seller::with('images', 'car_images', 'seller_fuel_types.fuel_type_name',
                                'condition',
                                'car_brand',
                                'model',
                                'bodytype',
        ...
        if ($total_samecar < 16) {
            $same_car2 = Seller::with('images', 'car_images', 'seller_fuel_types.fuel_type_name',
                                    'condition',
                                    'car_brand',
                                    'model',
                                    'bodytype',
...
//        dd($same_car);
        return view("frontEnd.fbCarDetails",
                compact("WebsiteSettings",
                        "WebmasterSettings",
                        "PageTitle",
                        "PageDescription",
