...
Route::get('/dealers-add', [DealersController::class, 'addDealer'])->name('add.dealer');
...
Route::post('/get_dealer_data',[DealersController::class,'get_dealer_data'])->name('get_dealer_data');

//Cars
Route::post('/get_buy_car_data',[CarsController::class,'get_buy_car_data'])->name('get_buy_car_data');
...
Route::post('/cars/{id}/updateBuy', [CarsController::class, 'updateBuy'])->name('updateBuy');
Route::post('/cars/{id}/updateExchange', [CarsController::class, 'updateExchange'])->name('updateExchange');
Route::get('/cars/destroy_edit/{id}', [CarsController::class, 'destroy_edit'])->name('carsDestroyEdit');
